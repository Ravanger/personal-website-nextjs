import styles from "./PatternTitleText.module.scss"
import { PatternTitleTextPropTypes } from "./PatternTitleText.types"

const PatternTitleText: React.FC<PatternTitleTextPropTypes> = ({
  title,
  alignDir = "LEFT",
  className,
}) => {
...
export default PatternTitleText
